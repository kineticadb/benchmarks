...
create or replace schema {{ snowflake_tpch_schema }};

create or replace TABLE {{ snowflake_tpch_schema }}.CUSTOMER (
...
create or replace TABLE {{ snowflake_tpch_schema }}.LINEITEM (
...
create or replace TABLE {{ snowflake_tpch_schema }}.NATION (
	N_NATIONKEY NUMBER(38,0) NOT NULL,
	N_NAME VARCHAR(25) NOT NULL,
	N_REGIONKEY NUMBER(38,0) NOT NULL,
	N_COMMENT VARCHAR(152)
);
create or replace TABLE {{ snowflake_tpch_schema }}.ORDERS (
...
create or replace TABLE {{ snowflake_tpch_schema }}.PART (
...
create or replace TABLE {{ snowflake_tpch_schema }}.PARTSUPP (
...
create or replace TABLE {{ snowflake_tpch_schema }}.REGION (
	R_REGIONKEY NUMBER(38,0) NOT NULL,
	R_NAME VARCHAR(25) NOT NULL,
	R_COMMENT VARCHAR(152)
);
create or replace TABLE {{ snowflake_tpch_schema }}.SUPPLIER (
